...
- Same as Q2-A and Q2-B, and maybe...
- `treatment_passport_binary`: Binary indicator for whether the person was in Phase 1 or Phase 2 of the pseduo RCT passport program
...
riders_final <- riders_clean %>% 
  ...
  group_by(id) %>% 
  mutate(across(c(incentive_cat, treatment_passport_binary), ~lag(.), .names = "{.col}_prev")) %>% 
  #
